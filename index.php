...
<body>
    ...
    <div class="container-fluid p-0">
        <!-- first child -->
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark " style="position:sticky; top:0;z-index:200000;">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="#">Total Price:
        ...
        <!-- second child -->
        <nav class="navbar navbar-expand-lg navbar-dark bg-secondary" style="    position: sticky;
    top: 20px;
    z-index: 1000;">
  ...
  ">
                ...
                <ul class="navbar-nav me-auto text-center">
                    <li class="nav-item " style="background-color:#2762f0;">
