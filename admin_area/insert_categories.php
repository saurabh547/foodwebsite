...
<form action="" method="post" class="mb-2">
    ...
    <div class="input-group w-10 mb-2 m-auto">
        ...
        <input type="submit" class="btn btn-outline-dark my-2 bg-info" name="insert_cat" value="Insert Categories"
            aria-label="Username" aria-describedby="basic-addon1" class="bg-info">
        <!-- <button class="bg-info btn my-3">Insert Categories</button> -->
    </div>
</form>